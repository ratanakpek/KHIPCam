...
interface IUserMethods {
    ...
    void setCallback(@NonNull MyVideoViewCallback callback);

    void setProgressCallback(@NonNull VideoProgressCallback callback);

    void setLeftAction(@MyVideoView.LeftAction int action);

    void setRightAction(@MyVideoView.RightAction int action);
